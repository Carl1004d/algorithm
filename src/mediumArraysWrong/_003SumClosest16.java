...
/**
 * Pick One Given an array nums of n integers and an integer target, find three
 ...
 * solution.
 */
public class _003SumClosest16 {
	public int threeSumClosest(int[] nums, int target) {
		// sort the nums array
		Arrays.sort(nums);
		int closestSum = 0;
		int diff = Integer.MAX_VALUE;
		// iterate nums array, no need for the last two numbers because we need
